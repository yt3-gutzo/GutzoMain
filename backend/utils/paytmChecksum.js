...
class PaytmChecksum {
	...
	static generateSignature(params, key) {
		console.log("generateSignature called with params:", params);
		console.log("generateSignature key:", key);
	...
	static getStringByParams(params) {
		console.log("getStringByParams called with:", params);
		var data = {};
		Object.keys(params).sort().forEach(function(key,value) {
			let val = params[key];
			// Only call .toLowerCase() if val is a string
